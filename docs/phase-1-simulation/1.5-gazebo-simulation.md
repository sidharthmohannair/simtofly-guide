...
**Alternative:** Gazebo Garden (LTS) — Also works, but Harmonic is newer.
...
**What these are:**
- `libgz-sim8-dev` — Gazebo development libraries
- `rapidjson-dev` — JSON parsing (for plugin)
...
✅ **Success:** Shows "Built target ArduPilotPlugin"
...
- `-v4` — Verbose output (helpful for debugging)
...
**Right panel:**
- Component inspector — Details of selected entity
...
**iris_runway.sdf** — Drone on runway (default)
**iris_maze.sdf** — Indoor maze environment  
**iris_warehouse.sdf** — Indoor warehouse
...
- **Harmonic** (recommended) — Latest stable, best support
- **Garden** — LTS release, more conservative choice
...
**A:** Advanced topic — Place models in `~/simtofly_ws/ardupilot_gazebo/models/` and they'll be available. We'll cover this in advanced tutorials.
